...
# # DDR[3].ADDR
# set_property -dict {PACKAGE_PIN B20 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][addr][14]}]
...
# set_property -dict {PACKAGE_PIN D18 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][addr][16]}]
# set_property -dict {PACKAGE_PIN C18 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][addr][11]}]
# set_property -dict {PACKAGE_PIN C21 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][addr][15]}]
...
# set_property -dict {PACKAGE_PIN N21 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][csL][0]}]
# set_property -dict {PACKAGE_PIN M21 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[3][csL][1]}]
...
# add_cells_to_pblock [get_pblocks MIG_XBAR3_GRP] [get_cells [list U_Mig3/U_Xbar]]
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ddrClkP[3]}] -group [get_clocks -include_generated_clocks pciRefClkP] -group [get_clocks -include_generated_clocks pciExtRefClkP]

# set_property HIGH_PRIORITY true [get_nets {U_MIG3/U_MIG/inst/u_ddr4_infrastructure/div_clk}]
