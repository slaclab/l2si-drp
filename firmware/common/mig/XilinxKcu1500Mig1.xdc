...
# # DDR[0].ADDR
# set_property -dict {PACKAGE_PIN AL14 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][addr][14]}]
...
# set_property -dict {PACKAGE_PIN AP13 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][addr][16]}]
# set_property -dict {PACKAGE_PIN AR13 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][addr][11]}]
# set_property -dict {PACKAGE_PIN AN14 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][addr][15]}]
...
# set_property -dict {PACKAGE_PIN BF13 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][csL][0]}]
# set_property -dict {PACKAGE_PIN AT14 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[1][csL][1]}]
...
# add_cells_to_pblock [get_pblocks MIG_XBAR1_GRP] [get_cells [list U_Mig1/U_Xbar]]
...
####################################################################################
# Constraints from file : 'XilinxKcu1500PcieExtendedCore.xdc'
####################################################################################
