...
# # DDR[2].ADDR
# set_property -dict {PACKAGE_PIN D31 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][addr][14]}]
...
# set_property -dict {PACKAGE_PIN A32 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][addr][16]}]
# set_property -dict {PACKAGE_PIN A33 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][addr][11]}]
# set_property -dict {PACKAGE_PIN D33 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][addr][15]}]
...
# set_property -dict {PACKAGE_PIN F34 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][csL][0]}]
# set_property -dict {PACKAGE_PIN F35 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[2][csL][1]}]
...
# add_cells_to_pblock [get_pblocks MIG_XBAR2_GRP] [get_cells [list U_Mig2/U_Xbar]]
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ddrClkP[2]}] -group [get_clocks -include_generated_clocks pciRefClkP] -group [get_clocks -include_generated_clocks pciExtRefClkP]

# set_property HIGH_PRIORITY true [get_nets {U_MIG2/U_MIG/inst/u_ddr4_infrastructure/div_clk}]
