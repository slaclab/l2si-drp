...
# # DDR[0].ADDR
# set_property -dict {PACKAGE_PIN AL34 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][addr][14]}]
...
# set_property -dict {PACKAGE_PIN AN32 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][addr][16]}]
# set_property -dict {PACKAGE_PIN AN33 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][addr][11]}]
# set_property -dict {PACKAGE_PIN AN34 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][addr][15]}]
...
# set_property -dict {PACKAGE_PIN BB38 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][csL][0]}]
# set_property -dict {PACKAGE_PIN BC38 IOSTANDARD SSTL12_DCI} [get_ports {ddrOut[0][csL][1]}]
...
# add_cells_to_pblock [get_pblocks MIG_XBAR0_GRP] [get_cells [list U_Mig0/U_Xbar]]
...
####################################################################################
# Constraints from file : 'XilinxKcu1500Mig1.xdc'
####################################################################################

set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ddrClkP[0]}] -group [get_clocks -include_generated_clocks pciRefClkP] -group [get_clocks -include_generated_clocks pciExtRefClkP]

# set_property HIGH_PRIORITY true [get_nets {U_MIG0/U_MIG/inst/u_ddr4_infrastructure/div_clk}]
